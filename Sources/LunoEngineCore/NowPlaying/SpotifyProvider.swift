...
public actor SpotifyProvider: NowPlayingProvider, NowPlayingControls {
    public nonisolated let source: NowPlayingSource = .spotify
    ...
    private func mapToTrack(_ raw: RawTrackInfo, now: Date) -> NowPlayingTrack {
        ...
        return NowPlayingTrack(
            ...
            isAdvertisement: raw.trackID?.hasPrefix("spotify:ad:") == true,
            updatedAt: now
        )
    }
}
